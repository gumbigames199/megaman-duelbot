...
export const data = new SlashCommandBuilder()
  ...
  .addStringOption(o => o.setName('region_id').setDescription('Region TSV id'))
  .addIntegerOption(o => o.setName('zone').setDescription('Zone number (1..region.zone_count)').setMinValue(1).setMaxValue(10));
...
export async function execute(ix: ChatInputCommandInteraction) {
  ...
  await ix.reply({ ephemeral:true, content:`ℹ️ Use /travel region_id:<id> to change region, or /travel zone:<n> to change zone.` });
}
